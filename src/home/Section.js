...
const Section = (prop) => {
  return (
    <Fragment>
      {/* Introduction */}
      <section className="w-full dark:text-light font-bodyFont">
        <div className="flex flex-col-reverse mx-14 lg:mx-[75px] pb-2 pt-10 lg:pt-20 items-center lg:items-start lg:justify-between lg:flex-row lg:pb-0">
          <div className="flex flex-col items-center text-center lg:text-left lg:items-start justify-center pt-4 lg:pt-0 lg:w-1/2">
            ...
            <div className="flex flex-col lg:mb-8">
              ...
              <div className="text-2xl lg:text-4xl font-semibold">
                ...
                <span className="text-gradient-highlighted font-semibold">web.</span>
              </div>
            </div>
            ...
            <div className="flex flex-col font-titleFont">
              ...
              <div className="text-center lg:text-left text-gray-800 font-semibold dark:font-normal dark:text-gray-300 tracking-tight mt-9 mb-2 uppercase">
                Find Me On:
              </div>
          ...
          <div className="lg:w-1/2">
            <div className="flex flex-col items-end justify-center lg:items-end lg:justify-end lg:relative">
              ...
              />
              <div className={`${prop.darkModeSwitch? "background-gradient" : "background-gradient-light"} rounded-t-3xl w-[320px] h-[280px] lg:w-[80%] lg:h-[90%] relative lg:absolute`}>
                <img
                  src={ralph}
                  alt="Ralph Caraan"
