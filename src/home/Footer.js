...
const Footer = () => {
  return (
    <Fragment>
      <footer className="px-20 relative bg-[#09090b]">
        <motion.div
          className="relative -top-24 max-w-4xl bg-gradient-to-r from-[#006677] via-bluish to-lightBlue mx-auto py-14 px-6 rounded-md"
          initial={{ y: 0 }}
          animate={{ y: [0, 17] }}
          transition={{
            duration: 1,
        ...
        <div className="flex flex-row items-start justify-between">
          <nav className="flex flex-row space-x-7 items-start justify-around py-10 font-medium"> 
            <Link to="/Home">Home</Link>
            <Link to="/About">About</Link>
            <Link to="/Projects">Projects</Link>
            <Link to="/Contacts">Contacts</Link>
          </nav>
          <div className="flex justify-end py-10 brightness-75">
